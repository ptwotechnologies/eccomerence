...
export const DivWrapperByAnima = (): JSX.Element => {
  ...
  return (
    <section className="w-full py-8 max-w-[1440px] mx-auto">
      <div className="flex flex-col md:flex-row gap-6 px-4">
        {promoCards.map((card) => (
          <Card
            key={card.id}
            className={`w-full h-[372px] ${card.bgColor} rounded-[20px] overflow-hidden border-2 border-solid border-[#13172b]`}
          >
            <CardContent className="p-0 h-full relative">
              <div className="relative w-full h-full pl-[52px]">
                ...
                />
                <div className="absolute w-[270px] h-[270px] top-12 left-0">
                  <div className="absolute w-[122px] h-[87px] top-[-5px] left-0">
                    ...
                    <div className="w-[122px] absolute top-[27px] left-0 [font-family:'DM_Sans',Helvetica] font-medium text-[#13172b] text-6xl tracking-[0] leading-[60px] whitespace-nowrap">
                      {card.discount}
                    </div>
                  </div>
                  ...
                  <Button className="absolute w-[133px] h-[50px] top-[220px] left-0 bg-[#13172b] rounded-[50px] hover:bg-[#13172b]/90">
